...
author: "tommylike"
header-img: "img/posts/hands-working.jpg"
catalog: true
tags:
- openstack
- python
...
跟markdown一样，在编写文档的时候，我们也需要能够本地即时预览，在这一点上Sublimetext和他强大的plugin在合适不过了，这里推荐[**OmniMarkupPreviewer**](https://github.com/timonwong/OmniMarkupPreviewer)，大部分的markup语言都支持预览:    
